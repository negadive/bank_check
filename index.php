...
<?php
echo "<table border='0' style='position: absolute;
    left: 0px;
    top: 42px;
...
<?php
echo "<div style='font-family: GulimChe, serif; position:absolute; left:23%; top:504px;'>".$row['negel']."<br></div>";
echo "<div style='font-family: GulimChe, serif; position:absolute; left:23%; top:534px;'>".$row['segel']."</div>";
?>
</div>
